  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mb-4">
        <!-- course thumb -->
        <img src="images/courses/ielts.jpg" class="img-fluid w-50">
      </div>
    </div>
    <!-- course info -->
    ...
    <div class="row">
      <div class="col-12 mb-4">
        <h3>About Course</h3>
        <p>Our IELTS preparation course will ensure you have 
        all the skills necessary to take the IELTS exam and 
          ...
          <div class="row">
            <div class="col-md-6">
              <ul class="list-styled">
                <li>Score above 3.5 in IELTS Mock test</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-12">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap">
          <div class="media mb-2 mb-sm-0">
            <img class="mr-4 img-fluid w-25" src="images/teachers/Jacke-Masito.jpg" alt="Teacher">
            <div class="media-body">
              <h4 class="mt-0">Jacke Masito</h4>
              Native speaker
            </div>
          </div>
