...
<head>
  <meta charset="utf-8">
  <title>GIRO-Specialized English</title>
      ...
      <div class="row">
        <div class="col-md-8">
          <ul class="list-inline custom-breadcrumb">
            <li class="list-inline-item"><h3 class="h2 text-light font-secondary">Specialised English Courses</h3>
            </li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mb-4">
        <!-- course thumb -->
        <img src="images/courses/spec-English.png" class="img-fluid w-50">
      </div>
    </div>
    <!-- course info -->
    <div class="row align-items-center mb-5">
      <div class="col-xl-3 order-1 col-sm-6 mb-4 mb-xl-0">
        <h2>Specialised English</h2>
      </div>
    ...
    <div class="row">
      <div class="col-12 mb-4">
        <h3>About Course</h3>
        <p>Our specialised English programme is comprised of twelve levels and
            is aimed at the development of the essential skills, necessary
            for successful communication in English language in Business and Tourism. The latest
            communicative methods and a well-balanced combination of such
            activities as reading, speaking, listening and writing makes this
            programme the right one regardless of the learning goals.
	      </p>
      </div>
      <div class="col-12 mb-4">
      ...
      <div class="col-12">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap">
          <div class="media mb-2 mb-sm-0">
            <img class="mr-4 img-fluid w-25" src="images/teachers/Alex-Rook.jpg" alt="Teacher" style="filter: blur(2px);">
            <div class="media-body">
              <h4 class="mt-0">Alex Rook</h4>
              Native speaker
            </div>
          </div>
