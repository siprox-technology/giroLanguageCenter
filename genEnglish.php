...
<head>
  <meta charset="utf-8">
  <title>GIRO-General English</title>
  <?php
      ...
      <div class="row">
        <div class="col-md-8">
          <ul class="list-inline custom-breadcrumb">
            <li class="list-inline-item"><h3 class="h2 text-light font-secondary">General English Courses</h3>
            </li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 mb-4">
        <!-- course thumb -->
        <img src="images/courses/generalEnglish.png" class="img-fluid w-50">
      </div>
    </div>
    <!-- course info -->
          ...
          <li class="list-inline-item mr-4 mb-3 mb-sm-0">
            <div class="d-flex align-items-center">
              ...
              <div class="text-left">
                ...
                <p class="mb-0">Adults From: $350 -- Kids From: $250</p>
              </div>
            </div>
          </li>
        </ul>
    ...
    <div class="row">
      <div class="col-12 mb-4">
        <h3>About Course</h3>
        <p>Our regular English programme is comprised of twelve levels and
            is aimed at the development of the essential skills, necessary
            for successful communication in English language. The latest
      ...
      <div class="col-12">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap">
          <div class="media mb-2 mb-sm-0">
            <img class="mr-4 img-fluid w-25" src="images/teachers/John-Doe.jpg" alt="Teacher">
