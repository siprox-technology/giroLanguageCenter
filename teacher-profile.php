...
<body id="profile_body_teacher">
  ...
  <div class="profile_container_TEACHER" id="profile_container">
    <!-- header -->
    <header class="header">
      <!-- top header -->
            ...
            <div class="col-lg-8 text-center text-lg-right">
              <ul class="list-inline">
                ...
                <?php   
                    ...
                    id='profileLink' href='teacher-profile.php'>"."Hi,  ".$_SESSION['name']."</a></li>";
...
<hr>
              ...
              <ul class="navbar-nav ml-auto text-center">
                ...
                <li class="nav-item dropdown view" id="user_tests_info">
                  ...
                  <div class="dropdown-menu" aria-labelledby="user_test_info_drop">
                    <a class="dropdown-item" onclick="get_test_result()" id="testResultLink" data-toggle='modal'
                    ...
                    <div class="container">
                      ...
                      <div class="row">
                        <div class="col-lg-12 text-center d-flex flex-column">
                          <a id="" class="btn btn-primary m-1 cursor_pointer" onclick="download_course_payment_pdf()">Download
                            PDF</a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-lg-12 text-center">
                  ...
                  <a id="updateClassListBtn" class="btn btn-primary cursor_pointer mt-3"
                    onclick="update_class_list_teacher()">Update</a>
                </div>
              </div>
  ...
  <!-- list of certificates for additional req -->
                            ...
                            <div class="col-12 col-lg-6 mx-auto">
                              ...
                              <div class="form-group" id="cert_payment_form">
                                <form role="form" id="crd-card-form">
                                  <div class="form-group">
                                    <label for="username">Full name (on the card)</label>
                                    <input type="text" id="cert_NameOnCard" name="name_on_card" placeholder="Name on card"
                                      required="" class="form-control form-control_xs">
                                  </div>
                                  <div class="form-group">
                                    <label for="cardNumber">Card number</label>
                                    <div class="input-group">
                                      <input type="text" id="cert_card_num" name="cardNumber" placeholder="Your card number"
                                        class="form-control form-control_xs" maxlength="16" required="">
                                    </div>
                                  </div>
                                  <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                      <div class="form-group mb-4">
                                        ...
                                        <label for="pin" class="float-right">PIN</label>
                                        <div class="input-group">
                                          <input type="text" maxlength="4" placeholder="CVV" id="cert_cvv-num" name="cvv"
                                            class="form-control form-control_xs" required="">
                                          <input type="text" maxlength="4" placeholder="PIN" id="cert_pin-code" name="pin"
                                            class="form-control form-control_xs" required="">
                                        </div>
                                      </div>
                                    </div>
